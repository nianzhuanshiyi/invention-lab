...
语言风格要求：
- 产品名称要像淘宝/亚马逊真实商品标题，朴实无华，例如"硅胶防溢锅盖""磁吸数据线收纳夹"
- 禁止使用以下词汇：智能、AI、军工级、航空级、黑科技、革命性、颠覆
- 材质描述要真实：硅胶、PP塑料、竹木、304不锈钢、牛津布、ABS塑料
- 功能描述要简单直接：防溅、可折叠、带刻度、磁吸固定、挂钩设计
- imagePrompt要描述一个你在超市货架上能看到的普通产品，不是概念设计
...
JSON格式：
{
  ...
  "score": 75,
  "imagePrompt": "英文描述一个真实存在的日用品外观。要求像超市里摆着的普通商品。说清楚材质(plastic/silicone/bamboo/fabric)、颜色、大小(跟什么东西差不多大)。绝对不要用futuristic/smart/high-tech这些词。(30-50 words)",
